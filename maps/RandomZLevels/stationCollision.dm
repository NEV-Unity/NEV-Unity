...
obj/item/weapon/gun/energy/laser/retro/sc_retro
	name ="retro laser"
	icon_state = "retro"
	desc = "An older model of the basic lasergun, no longer used by security or military forces."
...
/obj/item/weapon/paper/sc_safehint_paper_caf
	...
	info = "<font gamecolor=red><i>This paper is soaked in blood, it is impossible to read any text.</i></font>"
