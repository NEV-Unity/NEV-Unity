/datum/mutiny_fluff
	...
	proc/get_fax_body()
		return {"
			...
			<p>
				...
				<b>FROM:</b> United Stellar Nations Emergency Messaging Relay<br>
	...
	proc/get_pda_body()
		return {"<b>&larr; From Anonymous Channel:</b> <p>\"You must read this! United Stellar Nations Chain of Command COMPROMISED. Command Encryptions BROKEN. [station_name()] Captain [mode.head_loyalist] will receive orders that must NOT BE BROUGHT TO FRUITION!
...
Both keys are required to activate the <b>Emergency Authentication Device (EAD)</b> in the vault, signalling to United Stellar Nations that the directive is complete.
<hr>
<p>
<b>Loyalists</b> - Follow the Head Loyalist in carrying out [loyalist_tag("United Stellar Nations's directives")] then activate the <b>EAD</b>.<br>
<b>Mutineers</b> - Prevent the completion of the [mutineer_tag("improperly validated directives")] and the activation of the <b>EAD</b>.
	...
	proc/loyalist_major_victory()
		return {"
The United Stellar Nations has praised the efforts of Captain [mode.head_loyalist] and loyal members of [their(mode.head_loyalist)] crew, who recently managed to put down a mutiny--amid a local interstellar crisis--aboard the <b>[station_name()]</b>, a research station in [system_name()].
...
The United Stellar Nations will be awarding [mode.loyalists.len] members of the crew with the [loyalist_tag("Star of Loyalty")], following their successful efforts, at a ceremony this coming Thursday.
[mode.body_count.len] are believed to have died during the coup.
<p>The United Stellar Nations's image will forever be haunted by the fact that a mutiny took place on one of its own stations.</p>
		"}
...
[mode.mutineers.len] members of the station's personnel were charged with terrorist action against the Company and, if found guilty by a Sol magistrate, will be sentenced to life incarceration.
The United Stellar Nations will be awarding [mode.loyalists.len] members of the crew with the [loyalist_tag("Star of Loyalty")], following their mostly successful efforts, at a ceremony this coming Thursday.
[mode.body_count.len] are believed to have died during the coup.
<p>The United Stellar Nations's image will forever be haunted by the fact that a mutiny took place on one of its own stations.</p>
		"}
	...
	proc/no_victory()
		return {"
The United Stellar Nations has been thrust into turmoil following an apparent mutiny by key personnel aboard the <b>[station_name()]</b>, a research station in [system_name()].
The mutiny was spurred by a top secret directive sent to the station, presumably in response to the crisis within the system.
No further information has yet emerged from the station or its crew, who are presumed to be in holding with The United Stellar Nations investigators.
The United Stellar Nations officials refuse to comment.
...
The United Stellar Nations has reprimanded [mode.loyalists.len] members of the crew for failing to follow command validation procedures.
[mode.body_count.len] are believed to have died during the coup.
<p>Even though the directive was not successfully implemented, The United Stellar Nations' image will forever be haunted by the fact that its authentication protocol was breached with such magnitude and that a mutiny was the result.</p>
		"}

	proc/mutineer_major_victory()
		return {"
The United Stellar Nations has praised the efforts of [mode.head_mutineer.assigned_role] [mode.head_mutineer] and several other members of the crew, who recently seized control of a company station in [system_name()]--<b>[station_name()]</b>--amid a local interstellar crisis.
...
The United Stellar Nations has [mode.loyalists.len] members of the crew in holding, while it investigates the circumstances that led to the acceptance and initiation of an invalid directive.
[mode.body_count.len] are believed to have died during the coup.
<p>Even though the directive was not successfully implemented, The United Stellar Nations' image will forever be haunted by the fact that its authentication protocol was breached with such magnitude and that a mutiny was the result.</p>
		"}
...
<center><font color='red'>CONFIDENTIAL: PROPERTY OF USN</font></center>
...
TM: She worked, sir. We've had an ear on The USN's regional communications for weeks.<br>
...
TM: The intelligence hasn't been doing us any good. Anything that appears actionable, I send it to the analysts and they make a plan. Thing is, The USN always sees us coming.<br>
D: Tim...<br>
TM: I think they discovered the hack, sir. Case in point, <b>Energine Consolidated Solutions</b>. That subsidiary of ours that was awarded a lease on The USN's mining platform in Nyx? The USN acquired them a week before we made the announcement.<br>
...
D: Either way the transmission caused The USN to look at the satellite. They found out about Mallory.<br>
