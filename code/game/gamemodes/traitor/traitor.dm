...
/datum/game_mode/traitor
	name = "traitor"
	config_tag = "traitor"
	restricted_jobs = list("Cyborg", "Internal Affairs Agent", "Commander", "Captain")//Borgs are part of the AI if he is traitor so are they, they use to get double chances Added Implanted
	protected_jobs = list("Espatier", "Chief Petty Officer", "Marshal")//AI", Currently out of the list as malf does not work for shit
	required_players = 0
	required_enemies = 1
