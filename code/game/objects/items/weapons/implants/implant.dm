...
/obj/item/weapon/implant/loyalty
	...
	get_data()
		var/dat = {"
<b>Implant Specifications:</b><BR>
<b>Name:</b> United Stellar Nations Employee Management Implant<BR>
...
<b>Integrity:</b> Implant will last so long as the nanobots are inside the bloodstream."}
	...
	implanted(mob/M)
		...
		if(H.mind in ticker.mode.head_revolutionaries)
			H.visible_message("[H] seems to resist the implant!", "You feel the government tendrils of the USN try to invade your mind!")
			return 0
		else if(H.mind in ticker.mode:revolutionaries)
			ticker.mode:remove_revolutionary(H.mind)
		H << "\blue You feel a surge of loyalty towards the USN."
		return 1
	...
	implanted(mob/M)
		...
		H << "\blue The implant robs you of your faith in Nar-Sie, leaving only obedience to the USN."
		return 1
...
/obj/item/weapon/implant/death_alarm
	...
	get_data()
		var/dat = {"
<b>Implant Specifications:</b><BR>
<b>Name:</b> USN Lifesign Sensor<BR>
<b>Life:</b> Activates upon death.<BR>
