mob/living/carbon/proc/dream()
	...
	var/list/dreams = list(
		"an ID card","a bottle","a familiar face","a crewmember","a toolbox","an espatier","the captain",
		...
		"a unathi","a tesau","the ai core","the mining station","the research station","a beaker of strange liquid",
		)
	spawn(0)
