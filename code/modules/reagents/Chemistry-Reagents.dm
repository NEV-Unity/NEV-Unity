...
/*		silicate
	...
	*/
		...
		dexalin
			...
			reagent_state = LIQUID
			color = "#c8d8e3" // rgb: 200, 216, 227 (pale blue)
			overdose = REAGENTS_OVERDOSE
		...
		ethanol
			...
			reaction_obj(var/obj/O, var/volume)
				...
				if(istype(O,/obj/item/weapon/book))
					if(istype(O,/obj/item/weapon/tome))
