...
var/global/list/SKILL_PRE = list("Engineer" = SKILL_ENGINEER, "Roboticist" = SKILL_ORGAN_ROBOTICIST, "Espatier" = SKILL_SECURITY_OFFICER, "Chemist" = SKILL_CHEMIST)
...
datum/skill/knowledge/law
    ID = "law"
    name = "Law"
    desc = "Your knowledge of law and procedures. This includes Regulations, as well as general station rulings and procedures. A low level in this skill is typical for security officers, a high level in this skill is typical for captains."
    field = "Security"
    secondary = 1
