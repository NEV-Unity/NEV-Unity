...
/mob/living/silicon/robot/drone/New()
	...
	//Some tidying-up.
	flavor_text = "It's a tiny little repair drone. The casing is stamped with an USN logo and the subscript: 'United Stellar Recursive Repair Systems: Fixing Tomorrow's Problem, Today!'"
	updateicon()
