...
/obj/machinery/atm
	name = "\improper Automatic Teller Machine"
	...
	attack_hand(var/mob/user)
		if(istype(user, /mob/living/silicon))
			user << "\red Artificial unit recognized. Artificial units do not currently receive physical monetary compensation, as per regulation #1005."
			return
...
//						usr << sound('nya.mp3')
				...
				dat = null
				dat += "<h1>Automatic Teller Machine</h1><br/>"
